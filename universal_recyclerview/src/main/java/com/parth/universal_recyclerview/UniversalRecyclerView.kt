...
class UniversalRecyclerView : FrameLayout {
    ...
    private var noDataTextSize: Float = 0f
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        if (attrs != null && defStyleAttr != -1) {
            ...
            noDataTextSize = a.getDimension(R.styleable.UniversalRecyclerView_noDataTextSize, 16f)
        ...
        View.inflate(context, R.layout.recyclerview, null).apply {
            ...
            shimmerView = shimmer_view_container
            tvNoData = tv_no_data
            ...
            tvNoData?.textSize = noDataTextSize
